...
print(data.head())
#perform logistic regression for spam being 1 and not spam being 0
#split data into training and test sets
from sklearn.model_selection import train_test_split
X_train, X_test, y_train, y_test = train_test_split(data.drop('spam', axis=1), data['spam'], test_size=0.30, random_state=101)
